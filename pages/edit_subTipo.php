...
<div class="box-content">
	<h2><a href="parametrizacao"><i class="fa fa-arrow-circle-left left"></i></a><i class="fa fa-pencil"></i>Editar Sub-Tipo<div class="btn-pesq"><i class="fa fa-search"></i></div></h2>
